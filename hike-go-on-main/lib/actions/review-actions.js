/**
 * Server actions สำหรับจัดการรีวิวและคอมเมนต์
 */
"use server"
...
/**
 * เพิ่มรีวิวสถานที่แคมป์ปิ้ง
 * @param {string} campsiteId - ID ของสถานที่แคมป์ปิ้ง
 * @param {number} rating - คะแนนรีวิว (1-5)
 * @param {string} content - เนื้อหารีวิว
...
export async function addCampsiteReview(campsiteId, rating, content) {
  try {
    ...
    if (!session) {
      return { error: "กรุณาเข้าสู่ระบบก่อนเขียนรีวิว" }
    }
...
/**
 * ดึงข้อมูลรีวิวของแคมป์ไซต์
 * @param {string} campsiteId - ID ของแคมป์ไซต์
 * @returns {Object} ผลลัพธ์การดำเนินการ
 */
...
/**
 * เพิ่มคอมเม้นต์อุปกรณ์
 * @param {string} equipmentId - ID ของอุปกรณ์
 * @param {string} content - เนื้อหาคอมเม้นต์
 * @returns {Object} ผลลัพธ์การดำเนินการ
 */
...
/**
 * แก้ไขคอมเม้นต์อุปกรณ์
 * @param {string} commentId - ID ของคอมเม้นต์
 * @param {string} content - เนื้อหาคอมเม้นต์
 * @returns {Object} ผลลัพธ์การดำเนินการ
 */
...
/**
 * แก้ไขการตอบกลับคอมเม้นต์
 * @param {string} replyId - ID ของการตอบกลับ
 * @param {string} content - เนื้อหาการตอบกลับ
 * @returns {Object} ผลลัพธ์การดำเนินการ
 */
...
/**
 * ดึงข้อมูลคอมเม้นต์และการตอบกลับของอุปกรณ์
 * @param {string} equipmentId - ID ของอุปกรณ์
 * @returns {Object} ผลลัพธ์การดำเนินการ
 */
